...
<spring:message var="errorShort" code="logsniffer.exception.refintg.short" arguments="${typeLabel}" />
<spring:message var="errorDetail" code="logsniffer.exception.refintg.detail" arguments="${typeLabel}" />
